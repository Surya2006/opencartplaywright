//This will be a utility class to generate random data for testing purposes. It will use the faker library to generate random names, emails, phone numbers, etc.
